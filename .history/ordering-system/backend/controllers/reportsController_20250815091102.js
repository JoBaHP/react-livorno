...
exports.getSalesReport = async (req, res) => {
  ...
  try {
    ...
    // This updated query now calculates total revenue and also separates
    // it by order_type ('table' vs 'delivery').
    const totalsQuery = `
            SELECT 
                COUNT(*) as total_orders, 
                SUM(total) as total_revenue,
                SUM(CASE WHEN order_type = 'table' THEN total ELSE 0 END) as table_revenue,
