...
import { Printer, DollarSign, ClipboardList } from "lucide-react";
      ...
      {data && (
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
            <div className="bg-gradient-to-br from-green-500 to-teal-600 p-6 rounded-lg shadow-lg flex items-center gap-4">
              <DollarSign size={40} />
              <div>
            ...
            <div className="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 rounded-lg shadow-lg flex items-center gap-4">
