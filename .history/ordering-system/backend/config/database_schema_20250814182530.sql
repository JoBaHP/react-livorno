...
-- (Optional) Add some initial streets for your city
...
-- 2. Create an index on the new column to make searches fast
CREATE INDEX idx_streets_name_normalized ON streets USING gin (name_normalized gin_trgm_ops);

-- 3. (Optional) Populate the new column for any existing streets in your database
