...
// --- NEW: Helper function to load the cart from sessionStorage ---
...
export default function OnlineOrderingPage() {
  ...
  const placeDeliveryOrder = async (customerDetails) => {
    // --- FIX ---
    // The backend expects the customer's details to be in a nested object.
    // This correctly structures the data before sending it.
    const orderData = {
      cart,
      customerDetails: customerDetails, // Pass the whole details object
      paymentMethod: "cash",
