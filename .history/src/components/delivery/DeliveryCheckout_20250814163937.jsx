...
export default function DeliveryCheckout({ cart, onPlaceOrder, onBackToMenu }) {
  ...
  useEffect(() => {
    // Fetch the list of streets when the component loads
    api
      .getAllStreets()
      .then((data) => {
      ...
      .catch(() => setError("Could not load street list."));
  }, [api]);
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    try {
      // The full address string is now constructed in the parent component
