...
// --- FIX ---
// This constant needs to be defined at the top level so all API functions can use it.
const fetchOptions = {
  credentials: "include", // This tells fetch to send cookies with every request
};

const getAuthHeader = () => {
  // This is no longer needed for cookie-based auth but can be kept for future use if needed.
  return {};
};
