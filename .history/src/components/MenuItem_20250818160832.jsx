...
export default function MenuItem({
  ...
  const handleRemoveClick = () => {
    // This function is designed for simple, non-customizable items.
    // It finds the item in the cart and reduces its quantity.
    if (onRemoveFromCart) {
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          {/* --- FIX: Conditional button rendering --- */}
          {/* If the item is simple and in the cart, show a quantity stepper. */}
          {/* Otherwise, show the default "Add" or "Customize" button. */}
