...
import { useApi } from "@shared/ApiProvider"; // Using the alias
import MenuItem from "@shared/components/MenuItem"; // Using the alias
...
// NOTE: This CustomizationModal should also be moved to the shared folder.
