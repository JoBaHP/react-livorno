...
exports.placeDeliveryOrder = async (req, res) => {
  ...
  // --- FIX ---
  // Make the address more specific by adding the city and country.
  // In a production app, this could be configured in your .env file.
  ...
  // 2. Find the correct delivery zone
  let deliveryFee = 0;
  try {
  ...
  // 3. Calculate total and place the order
