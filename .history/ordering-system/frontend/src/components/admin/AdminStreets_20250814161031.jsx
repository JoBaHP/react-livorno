...
export default function AdminStreets() {
  ...
  const [cityName, setCityName] = useState("Novi Sad, Serbia");
  ...
  const handlePopulateStreets = async (e) => {
    ...
    try {
      ...
      setMessage(response.message || "Streets populated successfully.");
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      >
        <div className="flex-grow">
          ...
          <input
            ...
            placeholder="e.g., Novi Sad, Serbia"
            required
      ...
      {isPopulating && (
        <p className="mb-4 p-3 bg-blue-100 text-blue-800 rounded-md">
          Fetching streets from OpenStreetMap... This may take a moment.
        </p>
      )}
      {message && (
